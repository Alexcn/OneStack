 ...
 * @version 3.0
 */
public final class SnowflakeImpl {

  /**
   * 起始时间戳
   **/
  private final static long START_TIME = 1628755238396L;
  ...
  /*
  * Do not recommend using this method because the ip address is random
  * */
  public SnowflakeImpl(long dataCenterId) {
  ...
  public SnowflakeImpl(long dataCenterId, boolean clock, boolean randomSequence) {
   ...
   */
  public SnowflakeImpl(long dataCenterId, long workerId, boolean clock, long timeOffset, boolean randomSequence) {
